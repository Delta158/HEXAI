...
# python3 Hex.py "a=Minerva;python3 minerva/MCTS_Agent.py" "a=Disconnecting;python3 agents/DefaultAgents/DisconnectingAgent.py" -v -p
# python3 Hex.py "a=Minerva;python3 minerva/MCTS_Agent.py" "a=Illegal;python3 agents/DefaultAgents/IllegalMessageAgent.py" -v -p
# python3 Hex.py "a=Minerva;python3 minerva/MCTS_Agent.py" "a=Naive;python3 agents/DefaultAgents/NaiveAgent.py" -v -p
# python3 Hex.py "a=Minerva;python3 minerva/MCTS_Agent.py" "a=NoConn;python3 agents/DefaultAgents/NoConnectionAgent.py" -v -p
# python3 Hex.py "a=Minerva;python3 minerva/MCTS_Agent.py" "a=Terminaing;python3 agents/DefaultAgents/SelfTerminatingAgent.py" -v -p
# python3 Hex.py "a=Minerva;python3 minerva/MCTS_Agent.py" "a=Timeout;python3 agents/DefaultAgents/TimeoutAgent.py" -v -p
# python3 Hex.py "a=Minerva;python3 minerva/MCTS_Agent.py" "a=LongMsg;python3 agents/DefaultAgents/TooLongMessageAgent.py" -v -p



# python3 Hex.py "a=Minerva;python3 minerva/MCTS_Agent.py" "a=Alice;./agents/TestAgents/alice/alice" -v -p
# python3 Hex.py "a=Minerva;python3 minerva/MCTS_Agent.py" "a=Bob;./agents/TestAgents/bob/bobagent" -v -p
# python3 Hex.py "a=Minerva;python3 minerva/MCTS_Agent.py" "a=Jimmie;./agents/TestAgents/jimmie/Agentjimmie" -v -p
# python3 Hex.py "a=Minerva;python3 minerva/MCTS_Agent.py" "a=Joni;./agents/TestAgents/joni/joniagent --agent minimax --depth 2 --heuristic monte-carlo --num-playouts 500" -v -p
# python3 Hex.py "a=Minerva;python3 minerva/MCTS_Agent.py" "a=Rita;java -jar agents/TestAgents/rita/rita.jar" -v -p
...
class MCTS_Agent():
    ...
    def make_move(self):
        ...
        if self.turn_count == 0 and self.colour == "B":
